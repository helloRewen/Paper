...
SOURCE = ROOT / "results" / "main" / "checkpoint_stage_h23_h4_tables" / "h23_stage_comparison_table.csv"
OUTPUT = ROOT / "results" / "paper_tables" / "table_04_signal_marginal_contribution.csv"
